...
public class RangeGenerator implements ProblemGenerator {
	...
	public Problem generateProblem(Problem.Difficulty difficulty)
	{
		...
		if(scenario == 0)
		{
			...
			ANSWER = second + first - 1;
			final String pagesWithText = getNumWithString(second, "страницу", "страницы", "страниц", FEMININE);
			...
			ANSWER = second - first - 1;
			final String pagesWithText = getNumWithString(ANSWER, "страница", "страницы", "страниц", FEMININE);
